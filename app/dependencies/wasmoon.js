import { g as getAugmentedNamespace } from "./react.js";
var dist$1 = { exports: {} };
...
function requireDist() {
  ...
  (function(module, exports) {
    (function(global, factory) {
      ...
      const LUA_REGISTRYINDEX = -1e6 - 1e3;
...
${traceback}`;
      ...
      var initWasmModule = (() => {
        var _scriptDir = typeof document === "undefined" && typeof location === "undefined" ? require$$0.pathToFileURL(__filename).href : typeof document === "undefined" ? location.href : _documentCurrentScript && _documentCurrentScript.src || new URL("index.js", document.baseURI).href;
        return async function(moduleArg = {}) {
          ...
          if (n) {
            ...
            const { createRequire: a } = await Promise.resolve().then(() => __viteBrowserExternal$1);
            var require$1 = a(typeof document === "undefined" && typeof location === "undefined" ? require$$0.pathToFileURL(__filename).href : typeof document === "undefined" ? location.href : _documentCurrentScript && _documentCurrentScript.src || new URL("index.js", document.baseURI).href), fs = require$1("fs"), na = require$1("path");
            k ? r = na.dirname(r) + "/" : r = require$1("url").fileURLToPath(new URL("./", typeof document === "undefined" && typeof location === "undefined" ? require$$0.pathToFileURL(__filename).href : typeof document === "undefined" ? location.href : _documentCurrentScript && _documentCurrentScript.src || new URL("index.js", document.baseURI).href));
            ia = (b, c) => {
          ...
          function Ma(a) {
            ...
            a ? (u(!Ka[a]), Ka[a] = 1, null === I && "undefined" != typeof setInterval && (I = setInterval(() => {
              if (sa) clearInterval(I), I = null;
                ...
                var b = false, c;
                for (c in Ka) b || (b = true, z("still waiting on run dependencies:")), z(`dependency: ${c}`);
                b && z("(end of list)");
              }
          ...
          } else M = new URL("glue.wasm", typeof document === "undefined" && typeof location === "undefined" ? require$$0.pathToFileURL(__filename).href : typeof document === "undefined" ? location.href : _documentCurrentScript && _documentCurrentScript.src || new URL("index.js", document.baseURI).href).href;
          function Qa(a) {
            if (ka) return ka(a);
          ...
          var oc = {
            ...
            emscripten_resize_heap: (a) => {
              ...
              a >>>= 0;
              u(a > b);
              if (2147483648 < a) return z(`Cannot enlarge memory, requested ${a} bytes, but the limit is ${2147483648} bytes!`), false;
              for (var c = 1; 4 >= c; c *= 2) {
                var d = b * (1 + 0.2 / c);
          ...
          e.addFunction = (a, b) => {
            ...
            try {
              ...
              if ("function" == typeof WebAssembly.Function) {
                ...
                for (var h = { parameters: [], results: "v" == b[0] ? [] : [f[b[0]]] }, m = 1; m < b.length; ++m) u(b[m] in f, "invalid signature char: " + b[m]), h.parameters.push(f[b[m]]);
                b = new d(h, a);
              } else {
                d = [1];
                f = b.slice(0, 1);
            ...
            if (!(0 < Ia)) {
              ...
              if (!(0 < Ia)) {
                if (!uc && (uc = true, e.calledRun = true, !sa)) {
                  ...
                  for (R.ta = false; 0 < Fa.length; ) Fa.shift()(e);
                  aa(e);
...
//# sourceMappingURL=wasmoon.js.map
